"""
Django settings for 3commerce project.
...
CHAT_GPT_KEY = str(os.getenv('CHAT_GPT_KEY'))
PRINTFUL_KEY = str(os.getenv('PRINTFUL_KEY'))
CJ_EMAIL = str(os.getenv('CJ_EMAIL'))
CJ_PWD = str(os.getenv('CJ_PWD'))
...
STRIPE_WEBHOOK_SECRET = 'whsec_d63309e3d216089875a3243ff5e2b5b0be5d6a445ae698f52acfa4198b397991'
...
WSGI_APPLICATION = '3commerce.wsgi.application'
...
EMAIL_FROM = 'sellfast.app@gmail.com'
EMAIL_HOST_USER = 'sellfast.app@gmail.com'
EMAIL_HOST_PASSWORD = 'lxxvcdrwyjodmjxe'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
