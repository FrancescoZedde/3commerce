# Generated by Django 3.2.3 on 2023-05-15 18:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('onsaleEbay', models.BooleanField(default=False)),
                ('outOfStock', models.BooleanField(default=False)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='variant', to='main_app.inventoryitem')),
            ],
        ),
    ]
